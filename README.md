...
I'm a full stack developer with 1.5+ years of experience shipping production applications across the entire stack — from Next.js frontends to FastAPI/Node.js backends, deployed with Docker and AWS. Currently building AI-powered analytics dashboards and RAG-based data chat interfaces.
...
<p>
  ...
  <img alt="React Query" src="https://img.shields.io/badge/-React Query-FF4154?style=flat&logo=reactquery&logoColor=white" />
